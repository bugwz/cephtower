...
# Generated outputs:
# - backend/internal/integration/ceph/dashboard/endpoints/*.go
# - backend/internal/integration/ceph/dashboard/typed/*.go (except client.go)
...
def raw_header(category)
  <<~GO
    // Code generated by the Ceph Dashboard client generator; DO NOT EDIT.
