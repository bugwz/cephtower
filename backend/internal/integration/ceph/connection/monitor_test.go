...
func TestParseMonitorAddresses(t *testing.T) {
	cases := []struct {
		...
		{"mon-a:6789", 1},
		{"v1:192.0.2.1:6789/0,v1:192.0.2.2:6789/0", 2},
		{"v2:192.0.2.1:3300/0", 1},
		{"v2:192.0.2.1:3300/0,v2:192.0.2.2:3300/0", 2},
		{"[v2:192.0.2.1:3300/0,v1:192.0.2.1:6789/0],[v2:[2001:db8::1]:3300/0,v1:[2001:db8::1]:6789/0]", 4},
		{"[v2:192.0.2.1:3300/0,v1:192.0.2.1:6789/0] [v2:192.0.2.2:3300/0,v1:192.0.2.2:6789/0]", 4},
