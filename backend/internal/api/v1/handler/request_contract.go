...
func buildMutationRequestContracts() map[string]RequestContract {
	...
	add([]string{"rgw_zone.update"}, true, map[string]JSONField{"name": stringField(true), "new_name": stringField(true), "zonegroup": stringField(false), "realm_id": stringField(false)})
