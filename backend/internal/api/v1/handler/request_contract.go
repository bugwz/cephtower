...
func buildMutationRequestContracts() map[string]RequestContract {
	...
	add([]string{"rgw_zonegroup.update"}, true, map[string]JSONField{"name": stringField(true), "new_name": stringField(true), "realm_id": stringField(false), "endpoints": stringField(false), "default": boolField(false), "master": boolField(false)})
	...
	add([]string{"rgw_zone.create"}, true, map[string]JSONField{"name": stringField(true)})
