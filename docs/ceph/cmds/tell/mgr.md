...
## `ceph tell mgr.<id> dump_blocked_ops`
...
## `ceph tell mgr.<id> dump_blocked_ops_count`
...
## `ceph tell mgr.<id> dump_historic_ops`
...
## `ceph tell mgr.<id> dump_historic_ops_by_duration`
...
## `ceph tell mgr.<id> dump_historic_slow_ops`
...
## `ceph tell mgr.<id> dump_ops_in_flight`
...
## `ceph tell mgr.<id> dump_osd_network`
