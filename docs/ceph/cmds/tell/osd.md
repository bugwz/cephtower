...
## `ceph tell osd.<id> calc_objectstore_db_histogram`
...
## `ceph tell osd.<id> clear_shards_repaired`
...
## `ceph tell osd.<id> debug dump_missing`
...
## `ceph tell osd.<id> debug kick_recovery_wq`
...
## `ceph tell osd.<id> dump_blocked_ops`
...
## `ceph tell osd.<id> dump_blocked_ops_count`
...
## `ceph tell osd.<id> dump_blocklist`
...
## `ceph tell osd.<id> dump_historic_ops_by_duration`
...
## `ceph tell osd.<id> dump_historic_slow_ops`
...
## `ceph tell osd.<id> dump_objectstore_kv_stats`
...
## `ceph tell osd.<id> dump_op_pq_state`
...
## `ceph tell osd.<id> dump_osd_network`
...
## `ceph tell osd.<id> dump_osd_pg_stats`
...
## `ceph tell osd.<id> dump_pg_recovery_stats`
...
## `ceph tell osd.<id> dump_pgstate_history`
...
## `ceph tell osd.<id> dump_pool_statfs`
...
## `ceph tell osd.<id> dump_recovery_reservations`
...
## `ceph tell osd.<id> dump_scrub_reservations`
...
## `ceph tell osd.<id> dump_watchers`
...
## `ceph tell osd.<id> flush_journal`
...
## `ceph tell osd.<id> flush_store_cache`
...
## `ceph tell osd.<id> get_heap_property`
...
## `ceph tell osd.<id> get_latest_osdmap`
...
## `ceph tell osd.<id> get_mapped_pools`
...
## `ceph tell osd.<id> injectdataerr`
...
## `ceph tell osd.<id> injectecclearreaderr`
...
## `ceph tell osd.<id> injectecclearwriteerr`
...
## `ceph tell osd.<id> injectecreaderr`
...
## `ceph tell osd.<id> injectecwriteerr`
...
## `ceph tell osd.<id> injectmdataerr`
...
## `ceph tell osd.<id> mark_unfound_lost`
...
## `ceph tell osd.<id> reset_pg_recovery_stats`
...
## `ceph tell osd.<id> rotate-stored-key`
...
## `ceph tell osd.<id> schedule-deep-scrub`
...
## `ceph tell osd.<id> schedule-scrub`
...
## `ceph tell osd.<id> scrub_purged_snaps`
...
## `ceph tell osd.<id> set_heap_property`
...
## `ceph tell osd.<id> set_recovery_delay`
...
## `ceph tell osd.<id> setomapheader`
...
## `ceph tell osd.<id> trim stale osdmaps`
