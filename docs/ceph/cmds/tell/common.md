...
## `ceph tell <daemon>.<id> 0`

- 组件/模块：`ceph tell` / `common`
- 支持版本：16.2.15 - 20.2.2
- 权限：`rw`
...
## `ceph tell <daemon>.<id> config diff`
...
## `ceph tell <daemon>.<id> config diff get`
...
## `ceph tell <daemon>.<id> config get`
...
## `ceph tell <daemon>.<id> config help`
...
## `ceph tell <daemon>.<id> config set`
...
## `ceph tell <daemon>.<id> config show`
...
## `ceph tell <daemon>.<id> config unset`
...
## `ceph tell <daemon>.<id> counter dump`
...
## `ceph tell <daemon>.<id> counter schema`
...
## `ceph tell <daemon>.<id> dump_mempools`
...
## `ceph tell <daemon>.<id> get_command_descriptions`
...
## `ceph tell <daemon>.<id> git_version`
...
## `ceph tell <daemon>.<id> injectargs`
...
## `ceph tell <daemon>.<id> leak_some_memory`
...
## `ceph tell <daemon>.<id> log reopen`
...
## `ceph tell <daemon>.<id> perf histogram dump`
...
## `ceph tell <daemon>.<id> perf histogram schema`
...
## `ceph tell <daemon>.<id> perf reset`
...
## `ceph tell <daemon>.<id> perf schema`
...
## `ceph tell <daemon>.<id> perfcounters_dump`
...
## `ceph tell <daemon>.<id> perfcounters_schema`
