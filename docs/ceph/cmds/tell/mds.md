...
## `ceph tell mds.<id> client config`
...
## `ceph tell mds.<id> dirfrag merge`
...
## `ceph tell mds.<id> dirfrag split`
...
## `ceph tell mds.<id> dump_blocked_ops`
...
## `ceph tell mds.<id> dump_blocked_ops_count`
...
## `ceph tell mds.<id> dump_export_states`
...
## `ceph tell mds.<id> dump_historic_ops`
...
## `ceph tell mds.<id> dump_historic_ops_by_duration`
...
## `ceph tell mds.<id> dump_ops_in_flight`
...
## `ceph tell mds.<id> force_readonly`
...
## `ceph tell mds.<id> osdmap barrier`
...
## `ceph tell mds.<id> scrub purge_status`
...
## `ceph tell mds.<id> session config`
...
## `ceph tell mds.<id> session evict`
