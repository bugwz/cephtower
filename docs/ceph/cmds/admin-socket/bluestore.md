...
## `ceph daemon osd.<id> bluefs debug_inject_read_zeros`

- 组件/模块：`admin socket` / `bluestore`
- 支持版本：16.2.15 - 20.2.2
- 权限：`admin-socket`
...
## `ceph daemon osd.<id> bluefs files list`
...
## `ceph daemon osd.<id> bluestore allocator fragmentation`
...
## `ceph daemon osd.<id> bluestore allocator fragmentation histogram`
...
## `ceph daemon osd.<id> bluestore allocator score`
...
## `ceph daemon osd.<id> bluestore collections`
...
## `ceph daemon osd.<id> bluestore compression stats`
...
## `ceph daemon osd.<id> bluestore list`
...
## `ceph daemon osd.<id> bluestore onode metadata`
