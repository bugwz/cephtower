# Ceph 20.2.2 Dashboard API - Grafana

> 来源：`docs/references/ceph/src/pybind/mgr/dashboard/openapi.yaml`。
> 本文档由 Ceph Dashboard API 文档生成器自动生成，按 `/api/grafana` 路径域归类。
> 版本支持扫描范围：v16.2.15, v17.2.9, v18.2.8, v19.2.5, v20.2.2。

## 接口目录

- [`POST /api/grafana/dashboards`](#post-api-grafana-dashboards) - POST /api/grafana/dashboards
- [`GET /api/grafana/url`](#get-api-grafana-url) - List Grafana URL Instance
- [`GET /api/grafana/validation/{params}`](#get-api-grafana-validation-params) - GET /api/grafana/validation/{params}

## 接口详情

### `POST /api/grafana/dashboards`

- 摘要：POST /api/grafana/dashboards
- Tags：`Grafana`
- 安全：- jwt: []
...
- Content-Type: `application/vnd.ceph.api.v1.0+json`
- Schema: object; fields: instance; required: instance
...
- 摘要：GET /api/grafana/validation/{params}
- Tags：`Grafana`
- 安全：- jwt: []
