...
Ceph clusters through the native Ceph APIs and Ceph commands. The backend provides a
...
| Ceph | native Ceph APIs enabled | connection also requires MON addresses and a sufficiently privileged CephX client keys |
